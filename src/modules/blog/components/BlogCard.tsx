...
const BlogCard = ({
  ...
  return (
    <Link href={`/blogs/${slug}`}>
      ...
      >
        <div className='relative h-[400px] overflow-hidden rounded-xl duration-500'>
          <Image
        ...
        <div className='absolute flex h-full flex-col justify-between space-y-4 p-5'>
          <div className='flex flex-wrap gap-2'>
            {tags?.map((tag) => (
              <div
                key={tag}
                className='rounded-full bg-neutral-900/50 px-2.5 py-1 font-code text-xs text-neutral-400'
              >
          ...
          <div className='flex flex-col justify-end'>
            <div className='flex flex-col space-y-3'>
              <h3 className='text-lg font-medium font-sora text-neutral-100 group-hover:underline group-hover:underline-offset-4'>
                {title}
              </h3>
            ...
            <div className='flex justify-between gap-4 px-0.5 text-neutral-400'>
              <Tooltip title='by Swanand Wagh'>
                <Image
                  src='/images/swanand.png'
                  alt='Swanand Wagh'
                  width={25}
                  height={25}
